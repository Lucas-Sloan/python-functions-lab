...
def apply_discount(price, discount):
    # Calculate discount and subtract it from original price
...
def largest(a, b, c):
    # Use max() function to find largest number
    return max(a, b, c)
...
def product(*args):
    ...
    # Iterate through numbers passed as arguments and multiply them
    for num in args:
        result *= num
